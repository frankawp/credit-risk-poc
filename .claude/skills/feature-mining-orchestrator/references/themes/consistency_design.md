...
| 字段 | 来源表 | 必需/可选 |
|------|--------|----------|
| DAYS_EMPLOYED | application_train | 必需 |
| DAYS_BIRTH | application_train | 必需 |
...
| `consistency_email_valid` | 邮箱是否有效格式 | 无效邮箱可能是虚假资料 |

**数据需求**：
| 字段 | 来源表 | 必需/可选 |
|------|--------|----------|
| FLAG_MOBIL | application_train | 必需 |
| FLAG_EMP_PHONE | application_train | 必需 |
| FLAG_WORK_PHONE | application_train | 必需 |
...
| 字段 | 来源表 | 必需/可选 |
|------|--------|----------|
| AMT_APPLICATION | previous_application | 必需 |
| AMT_CREDIT | previous_application | 必需 |
...
| 字段 | 来源表 | 必需/可选 |
|------|--------|----------|
| NAME_CONTRACT_STATUS | previous_application | 必需 |
...
3. **低优先级**（数据依赖）：
   - consistency_email_valid（需要邮箱字段）
